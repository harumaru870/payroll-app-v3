        ...
        <>
            <div className="p-8 border-b border-gray-50 flex items-center justify-between">
                ...
                <button
                    ...
                    className="flex items-center gap-1 px-4 py-2 bg-indigo-50 text-indigo-700 rounded-xl hover:bg-indigo-100 transition-colors font-bold text-sm"
                >
                ...
                <table className="w-full text-left">
                    <thead>
                        <tr className="bg-gray-50/50">
                            <th className="px-8 py-4 text-xs font-bold text-gray-400 uppercase tracking-wider">適用開始日</th>
                            <th className="px-8 py-4 text-xs font-bold text-gray-400 uppercase tracking-wider">基本時給</th>
                            <th className="px-8 py-4 text-xs font-bold text-gray-400 uppercase tracking-wider">交通費</th>
                        </tr>
                    </thead>
                                ...
                                <tr key={wage.id} className={isActive ? 'bg-indigo-50/30' : ''}>
                                    ...
                                    <td className="px-8 py-5">
                                        <div className="flex items-center gap-1 font-extrabold text-gray-900">
                                            ...
                                            <span className="text-xs text-gray-400 font-medium">円</span>
                                        </div>
                                    </td>
                                    <td className="px-8 py-5">
